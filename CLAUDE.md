...
4. **Netflix port (post-launch).** Owed prerequisite: run `spike/netflix/capture-kit.js` on a live authenticated session to seed the VTT/TTML parsers with real data, then build the platform-agnostic adapter (~1180 LOC est. per recon).
