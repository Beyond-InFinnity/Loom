...
**🎯 Active focus — v0.3.0 RELEASE PREP (4 platforms). iQIYI (iq.com) + WeTV (wetv.vip) added + live-verified on Firefox + Chrome (windowed + fullscreen) this session. Remaining: Connor pushes the local extension commits to `main` + uploads 0.3.0 to AMO + Chrome Web Store.**
